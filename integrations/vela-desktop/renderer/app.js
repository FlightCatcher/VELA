...
import { clampImageProgress, estimateImageProgress, messageListRenderKey } from "./message-render-state.js?v=2.5.0-beta.2";
...
const translations = {
  zh: {
    ...
    healthReady: "VELA 2.5.0-beta.2 · 就绪",
    healthDegraded: "VELA 2.5.0-beta.2 · 部分服务离线",
    healthMemory: "内存压力较高",
    connecting: "正在连接",
    disconnected: "连接中断",
    dropFiles: "释放以上传文件",
  ...
  en: {
    ...
    healthReady: "VELA 2.5.0-beta.2 · Ready",
    healthDegraded: "VELA 2.5.0-beta.2 · Degraded",
